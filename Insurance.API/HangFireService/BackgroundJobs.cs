...
//using Insurance.Services.ProcessPayment.Concrete;
//using Insurance.Services.ProcessPayment.Interface;
//using Insurance.Services.ShagoPayment.Electricty.Interface;
//using Insurance.Services.Vatebra.Electricty.EKO.DTO;
//using Insurance.Utilities.Common;
//using Insurance.Utilities.Enums;

//namespace Insurance.API.HangFireService
//{
...
//        public BackgroundJobs(IEmailing emailManager, IConfiguration configuration, IElectricityShago electricityShago, InsuranceAppContext context, IProcessPayment processPayment)
//        {
