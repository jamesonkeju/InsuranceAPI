...
using Insurance.Services.FAQsDTO.DTO;
using Insurance.Services.FAQs.Interface;

namespace Insurance.Services.FAQs.Concrete
{
    public class FAQsServices : IFAQs
    {
        ...
        public FAQsServices(InsuranceAppContext context, ILogger<FAQsServices> logger, IActivityLog activityLogService, ICommonRoute commonServices)
        {
            _context = context;
        ...
        public async Task<List<Data.Models.Domains.Faq>> GetAllQuestionAndAnswers(FAQsFilter payload)
        {
            ...
            {
                await _commonServices.LogError(ex);
                return new List<Insurance.Data.Models.Domains.Faq>();
            }
        }
        public async Task<Data.Models.Domains.Faq> GetFAQsById(long id, bool CheckDeleted)
        {
            var bind = new Insurance.Data.Models.Domains.Faq();
