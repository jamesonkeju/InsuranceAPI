...
namespace Insurance.Services.CommonRoute.concrete
{
    public class CommonRouteServices : ICommonRoute
    {
        private readonly InsuranceAppContext _appcontext;
        private readonly ILogger<CommonRouteServices> _logger;
        private ILogger<CommonRouteServices> logger;

        public CommonRouteServices(InsuranceAppContext appcontext)
        {
