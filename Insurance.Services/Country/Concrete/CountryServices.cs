...
namespace Insurance.Services.Country.Concrete
{
    public class CountryServices : ICountry
    {
        ...
        public CountryServices(InsuranceAppContext context,ILogger<CountryServices> logger, IActivityLog activityLogService,ICommonRoute commonServices)
        {
            _context = context;
        ...
        public async Task<List<Data.Models.Domains.Country>> GetAllCountries(CountryFilter payload)
        {
            ...
            {
                await _commonServices.LogError(ex);
                return new List<Insurance.Data.Models.Domains.Country>();
            }
        }
        public async Task<Data.Models.Domains.Country> GetCountryById(long id, bool CheckDeleted)
        {
            var bind = new Insurance.Data.Models.Domains.Country();
