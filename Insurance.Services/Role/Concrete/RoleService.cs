...
namespace Insurance.Services.Role.Concrete
{
    public class RoleService : IRole
    {
        ...
        public RoleService(InsuranceAppContext context, ILogger<RoleService> logger, IActivityLog activityLogService, ICommonRoute commonServices)
        {
            _context = context;
