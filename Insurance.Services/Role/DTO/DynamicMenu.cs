...
namespace Insurance.Services.Role.DTO
{
    public class DynamicMenu
    {
        ...
        public static List<SidebarMenuViewModel> GenerateUrl(List<Insurance.Data.Models.Indentity.Permission> parentMenus, List<Insurance.Data.Models.Indentity.Permission> menus, StringBuilder sb)
        {
