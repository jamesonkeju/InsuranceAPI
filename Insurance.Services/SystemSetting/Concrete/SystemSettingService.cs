...
namespace Insurance.Services.SystemSetting.Concrete
{
    public class SystemSettingService : ISystemSetting
    {
        ...
        public SystemSettingService(InsuranceAppContext context, ILogger<SystemSettingService> logger, IActivityLog activityLog, ICommonRoute commonServices)
        {
            _context = context;
            _logger = logger;
        ...
        public async Task<MessageOut> CreateUpdateSystemSetting(SystemSettingViewModel payload)
        {
            ...
            try
            {
                ...
                var extendingRecord = new List<Insurance.Data.Models.Domains.SystemSetting>();
                ...
                {
                    var addData = new Insurance.Data.Models.Domains.SystemSetting
                    {
        ...
        public async Task<MessageOut> DeleteSystemSetting(DeleteSystemSettingViewModel payload)
        {
            ...
            try
            {
                ...
                string msg = string.Empty;
                var roleExists = new List<Insurance.Data.Models.Domains.SystemSetting>();
