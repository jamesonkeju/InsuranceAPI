...
using Insurance.Services.Account.DTO;
using Insurance.Services.Account.Interface;
...
namespace Insurance.Services.Account.Concrete
{
    public class AccountServices :IAccount
    {
        ...
        public AccountServices(UserManager<ApplicationUser> userManager,
            ...
            InsuranceAppContext context, IActivityLog activityRepo, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public LoginDataDTO PrepareUserMenu(ApplicationUser user, List<ApplicationRoleViewModel> roles)
        {
            ...
            if (role != null)
            {
                ...
                DataTable menuList = accessDataLayer.
                    FetchRolePermissionsByRoleId(parameters.ToArray(), Insurance.Utilities.Common.StoredProcedureName.FetchUserPermissionAndRole);

                List<Insurance.Data.Models.Indentity.Permission> menus = new List<Insurance.Data.Models.Indentity.Permission>();

                foreach (DataRow dataRow in menuList.Rows)
                {
                    var permission = new Insurance.Data.Models.Indentity.Permission
                    {
                ...
                var SelectedParentMenus = new List<Insurance.Data.Models.Indentity.Permission>();
                List<Insurance.Data.Models.Indentity.Permission> SelectedParentMenusOrder = new List<Insurance.Data.Models.Indentity.Permission>();
