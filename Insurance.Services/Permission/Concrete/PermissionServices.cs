...
namespace Insurance.Services.Permission.Concrete
{
    public class PermissionServices : IPermission
    {
        ...
        public PermissionServices(InsuranceAppContext context, ILogger<PermissionServices> logger, IActivityLog activityLog, IConfiguration config,
        ...
        public async Task<MessageOut> AddUpdatePermission(PermissionViewModel payload)
        {
            ...
            try
            {
                ...
                var roleExists = new List<Insurance.Data.Models.Indentity.Permission>();
                ...
                {
                    var addData = new Insurance.Data.Models.Indentity.Permission
                    {
