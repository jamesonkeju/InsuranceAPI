...
namespace Insurance.Services.Emailing.Concrete
{
    ...
    public class EmailingService : IEmailing
    {
        ...
        public EmailingService(InsuranceAppContext context,ILogger<EmailingService> logger, IActivityLog activityLog, IConfiguration config,
     ...
     , string bcc,
           List<EmailTokenViewModel> emailTokens, string createdBy, bool EmailScheduler, bool TranslateMessage = false, string TranslateContent = "")
        {
            ...
            try
            {
                var dbdata = new InsuranceAppContext();
        ...
        public bool SendEmail(EmailLogViewModel emailModel, bool IsEmailScheduler, string createdBy)
        {
            ...
            var aPPContext = new InsuranceAppContext();
