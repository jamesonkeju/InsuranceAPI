...
namespace Insurance.Services.User.Concrete
{
    public class UserManagementServices : IUserManagement
    {
        ...
        public UserManagementServices(InsuranceAppContext context, ILogger<UserManagementServices> logger, IActivityLog activityLog, IConfiguration config,
        ...
        {
            if (AccountType == Insurance.Utilities.Common.DefineRoles.SubDealer)
            {
                return await (from x in _context.Users
                              join y in _context.Roles on x.RoleId equals y.Id
            ...
            else if (AccountType == Insurance.Utilities.Common.DefineRoles.Customer)
            {
                return await (from x in _context.Users
                              join y in _context.Roles on x.RoleId equals y.Id
            ...
            else if (AccountType == Insurance.Utilities.Common.DefineRoles.Dealer)
            {
                return await (from x in _context.Users
                              join y in _context.Roles on x.RoleId equals y.Id
                              join r in _context.ApplicationRoles on x.RoleId equals r.Id
        ...
        public async Task<CustomResponse> AddUpdateCustomer(UserViewModel obj, bool isPrimary)
        {
            ...
            try
            {
                ...
                if (obj.Id == string.Empty || obj.Id == "")
                {
                    ...
                    {
                        // newRecord.PasswordHash = SHAUtil.Encrypt(obj.Password);
                        newRecord.RoleId = Insurance.Utilities.Common.DefineRole.Customer;
                        RoleId = Insurance.Utilities.Common.DefineRole.Customer;
                    }
                    else
                    {
                        
                        newRecord.RoleId = Insurance.Utilities.Common.DefineRole.Sub_Dealer;
                        RoleId = Insurance.Utilities.Common.DefineRole.Sub_Dealer;
                    }
                    //save the record
                    var result = await _userManager.CreateAsync(newRecord);
                    ...
                    if (result.Succeeded)
                    {
                            ...
                            var emailTokens_t = new List<EmailTokenViewModel>
                        {
                            ...
                            await _emailingService.PrepareEmailLog(EmailTemplateCode.Insurance_TOKEN, obj.Email, _configuration["cc"], "", emailTokens_t, userInfo.Id, false);
                        }
        ...
        public async Task<CustomResponse> RegenerateOTP(OTPPayload payload)
        {
            ...
            try
            {
                ...
                await _emailingService.PrepareEmailLog(EmailTemplateCode.Insurance_TOKEN, userInfo.Email,
        ...
        public async Task<UpdateUserViewModel> UpdateUserMobile(Insurance.Data.Models.ViewModel.UpdateUserViewModel model)
        {
        ...
        public async Task<UserViewModel> CreateUserMobile(Insurance.Data.Models.ViewModel.UserViewModel model)
        {
            ...
            try
            {
                ...
                model.Password = Insurance.Utilities.Common.PasswordGenerator.GenerateRandomPassword();
