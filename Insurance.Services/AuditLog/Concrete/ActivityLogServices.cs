...
namespace Insurance.Services.AuditLog.Concrete
{
    public class ActivityLogServices : IActivityLog
    {
        ...
        public ActivityLogServices(InsuranceAppContext context, ILogger<ActivityLogServices> logger)
        {
            _context = context;
            _logger = logger;
        }
        ...
        public void CreateActivityLog(string description, string moduleName, string moduleAction, string userid, object record, object OldRecord)
        {
            ...
            try
            {
                ...
                var alog = new ActivityLog
                {
                    ...
                    IPAddress = Insurance.Utilities.Common.IPAddressUtil.GetLocalIPAddress()
